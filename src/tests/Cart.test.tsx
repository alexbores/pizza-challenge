...
describe('Cart Integration', () => {
    it('accurately aggregates multiple product additions', () => {
        ...
        const pizza1 = { id: 1, name: 'Margherita', price: 10, quantity: 1, image: 'test.jpg' };
        const pizza2 = { id: 2, name: 'Pepperoni', price: 15, quantity: 2, image: 'test.jpg' };
        const pizza3 = { id: 3, name: 'Veggie', price: 12, quantity: 1, image: 'test.jpg' };
